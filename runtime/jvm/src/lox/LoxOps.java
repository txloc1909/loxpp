...
public final class LoxOps {
    ...
    /**
     * Builds, but does not throw, the error. The JVM emitter (R4, PR #113
     * round 1) needs a real terminal instruction in the generated bytecode,
     * not only a void call the verifier cannot prove always throws; it
     * takes the returned object and follows it with an athrow itself.
     */
