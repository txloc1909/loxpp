...
PROBES = [
    ...
    ("list index wrong type", 'try { var l = [1]; l["a"]; } catch (e) { print e.kind; }',
     CATCHABLE, "IndexTypeError", '"List index must be a number."'),
    ("string index wrong type", 'try { "ab"["a"]; } catch (e) { print e.kind; }',
     CATCHABLE, "IndexTypeError", '"String index must be a number."'),
    ("list index not an integer", "try { var l = [1]; l[1.5]; } catch (e) { print e.kind; }",
     CATCHABLE, "IndexNotIntegerError", '"List index must be an integer."'),
    ("string index not an integer", 'try { "ab"[1.5]; } catch (e) { print e.kind; }',
     CATCHABLE, "IndexNotIntegerError", '"String index must be an integer."'),
    ("list index out of bounds", "try { [][0]; } catch (e) { print e.kind; }",
     CATCHABLE, "IndexOutOfBoundsError", '"List index out of bounds."'),
    ("string index out of bounds", 'try { "ab"[5]; } catch (e) { print e.kind; }',
     CATCHABLE, "IndexOutOfBoundsError", '"String index out of bounds."'),
    ("index-get of a non-indexable value", "try { 42[0]; } catch (e) { print e.kind; }",
     CATCHABLE, "NotIndexableError", '"Only lists, strings, and maps can be indexed."'),
    ...
    ("'+' on incompatible types", 'try { 1 + "a"; } catch (e) { print e.kind; }',
     CATCHABLE, "ConcatenationTypeError", '"Operands must be two numbers, two strings, or a string and a number."'),
    ...
    ("undefined property on an Error value",
     ...
     CATCHABLE, "UndefinedPropertyError", '"Undefined property on error."'),
    ...
    ("call of a non-callable value (fused, catchable)", "try { 42(); } catch (e) { print e.kind; }",
     CATCHABLE, "NotCallableError", '"Can only call functions, classes and enums."'),
    ("field shadowing a method, not callable (fused, fatal)",
     "class C { init() { this.f = 1; } } try { C().f(); } catch (e) { print e.kind; }",
     FATAL, "NotCallableError", '"Can only call functions, classes and enums."'),
